...
<html>
    ...
    <link href="./mission5-1.css" type="text/css" rel="stylesheet">
    <h1 id = main_title>掲示板</h1>
</html>
<body>
<?php
//データベース接続
...
?>
<h3 class="Administrator">テーブル削除(管理者)</h3>
<div class="form">
<form action="" method="POST">
